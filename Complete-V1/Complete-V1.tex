...
blood mononuclear cell samples from individuals with myocardial
...
(AUC-ROC) to separate the CAD/MI samples. We designed a two-layer
architecture for sample classification, with the first layer isolating
healthy samples from not-healthy ones, and the second layer classifying
stable CAD and MI samples. We trained different machine learning models
using both biomarker sets and evaluated their performance on a test set.
We identified miR-21, miR-186, and miR-32 as the only miRNAs among the
...
using the biomarker set selected by AUC-ROC, with an AUC-ROC of 0.95,
and an accuracy of 0.88. Our study demonstrated that miRNA signatures
derived from peripheral blood could serve as valuable novel biomarkers
...
{\centering \includegraphics[width=0.45\linewidth]{../../DEG and DEM/Pics/venny} 
...
{\centering \includegraphics[width=0.9\linewidth]{../../ML/Pics/Expressionforall} 
...
{\centering \includegraphics[width=0.65\linewidth]{../../ML/Pics/Models AUC 5 mirs CV} 
