...
\title{Unlocking the Potential of microRNAs: Machine Learning Identifies
Key Biomarkers for Myocardial Infarction Diagnosis }



\author{  Mehrdad Samadishadlou \and  Reza Rahbarghazi \and  Zeynab
Piryaei \and  Mahdad Esmaeili \and  Çığır Biray Avcı \and  Farhad
Bani \and  Kaveh Kavousi \and  }
...
%             \emph{Present address:} of F. Author  %  if needed
    \and
        Mahdad Esmaeili \at
     Medical Bioengineering Department, School of Advanced Medical
Sciences, Tabriz University of Medical Sciences, Tabriz, Iran \\
     %  \\
%             \emph{Present address:} of F. Author  %  if needed
    \and
        Çığır Biray Avcı \at
     Medical Biology Department, School of Medicine, Ege University,
İzmir, Turkey \\
     %  \\
%             \emph{Present address:} of F. Author  %  if needed
    \and
...
Department of Bioinformatics, Institute of Biochemistry and Biophysics
(IBB), University of Tehran, Iran \\
     \email{\href{mailto:kkavousi@ut.ac.ir}{\nolinkurl{kkavousi@ut.ac.ir}}}  %  \\
%             \emph{Present address:} of F. Author  %  if needed
    \and
    }
...
Refrence.bib,discussion.bib,Introduction.bib,mir296.bib}
